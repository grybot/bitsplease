...
public interface MatchRepository extends JpaRepository<Match, UUID> {
    ...
    @Query(nativeQuery =true, value=
            "SELECT " +
            " JobOfferSkills.jobOffer_jobOfferId JobOfferSkillsId " +
            " ApplicantSkills.applicant_ApplicantId AppId " +
            " FROM " +
            " JobOfferSkills " +
                   " LEFT JOIN " +
            " ApplicantSkills " +
            ...
            " WHERE " +
           " JobOfferSkills.jobOffer_jobOfferId NOT IN " +
            " ( " +
                  "  SELECT " +
            " JobOfferSkills.jobOffer_jobOfferId" +
            " FROM " +
            " JobOfferSkills" +
            " LEFT JOIN " + " ApplicantSkills " +
            " ON " + " JobOfferSkills.skills_skillsId = ApplicantSkills.skills_skillsId " +
            " WHERE " +
            " ApplicantSkills.applicant_ApplicantId IS NULL " +
    " ) " +
    " GROUP BY " +
    " JobOfferSkills.jobOffer_jobOfferId, " +
